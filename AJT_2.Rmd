...
mod_0_LDTa <- glmer(accuracy ~ 1 + (1|participant),
               family = binomial(link = "logit"), 
               data = frontiers_long,
               control = lbfgs_ctrl)

mod_1_LDTa <- glmer(accuracy ~ 1 + (1|participant) + (1|item),
               family = binomial(link = "logit"), 
               data = frontiers_long,
               control = lbfgs_ctrl)

mod_2_LDTa <- glmer(accuracy ~ Arabic_glob_scale*condition + (1|participant) + (1|item),
               family = binomial(link = "logit"),
               data = frontiers_long,
               control = lbfgs_ctrl)

mod_3_LDTa <- glmer(accuracy ~ Arabic_glob_scale*condition + (1|participant) + (1|item),
               family = binomial(link = "logit"),
               data = frontiers_long,
               control = lbfgs_ctrl)

mod_4_LDTa <- glmer(accuracy ~ Arabic_glob_scale*condition + (1|participant) + (1|item) + (1+condition|participant),
               family = binomial(link = "logit"),
               data = frontiers_long,
               control = lbfgs_ctrl)

mod_5_LDTa <- glmer(accuracy ~ Arabic_glob_scale*condition + (1|participant) + (1|item) + (1+condition|participant) + (1+item|participant),
               family = binomial(link = "logit"),
               data = frontiers_long,
               control = lbfgs_ctrl)

print(anova(mod_0_LDTa, mod_1_LDTa, mod_2_LDTa, mod_3_LDTa,mod_4_LDTa, mod_5_LDTa ))
```


```{r}
print(summary(mod_4_LDTa))
```

Models with English global
```{r}

mod_0_LDTe <- glmer(accuracy ~ 1 + (1|participant),
               family = binomial(link = "logit"),
               data = frontiers_long,
               control = lbfgs_ctrl)

mod_1_LDTe <- glmer(accuracy ~ 1 + (1|participant) + (1|item),
               family = binomial(link = "logit"),
               data = frontiers_long,
               control = lbfgs_ctrl)

mod_2_LDTe <- glmer(accuracy ~ English_glob_scale*condition + (1|participant) + (1|item),
               family = binomial(link = "logit"),
               data = frontiers_long,
               control = lbfgs_ctrl)

mod_3_LDTe <- glmer(accuracy ~ English_glob_scale*condition + (1|participant) + (1|item),
               family = binomial(link = "logit"),
               data = frontiers_long,
               control = lbfgs_ctrl)

mod_4_LDTe <- glmer(accuracy ~ English_glob_scale*condition + (1|participant) + (1|item) + (1+condition|participant),
               family = binomial(link = "logit"),
               data = frontiers_long,
               control = lbfgs_ctrl)

mod_5_LDTe <- glmer(accuracy ~ English_glob_scale*condition + (1|participant) + (1|item) + (1+condition|participant) + (1+item|participant),
               family = binomial(link = "logit"),
               data = frontiers_long,
               control = lbfgs_ctrl)

print(anova(mod_0_LDTe, mod_1_LDTe, mod_2_LDTe, mod_3_LDTe,mod_4_LDTe, mod_5_LDTe))
```


```{r}
print(summary(mod_2_LDTe))
```
...
## performing without group - dominance score
...
mod_0_LDTf <- glmer(accuracy ~ 1 + (1|participant),
               family = binomial(link = "logit"), 
               data = frontiers_long,
               control = lbfgs_ctrl)

mod_1_LDTf <- glmer(accuracy ~ 1 + (1|participant) + (1|item),
               family = binomial(link = "logit"), 
               data = frontiers_long,
               control = lbfgs_ctrl)

mod_2_LDTf <- glmer(accuracy ~ Domscale*condition + (1|participant) + (1|item),
               family = binomial(link = "logit"),
               data = frontiers_long,
               control = lbfgs_ctrl)

mod_3_LDTf <- glmer(accuracy ~ Domscale*condition + (1|participant) + (1|item),
               family = binomial(link = "logit"),
               data = frontiers_long,
               control = lbfgs_ctrl)

mod_4_LDTf <- glmer(accuracy ~ Domscale*condition + (1|participant) + (1|item) + (1+condition|participant),
               family = binomial(link = "logit"),
               data = frontiers_long,
               control = lbfgs_ctrl)

mod_5_LDTf <- glmer(accuracy ~ Domscale*condition + (1|participant) + (1|item) + (1+condition|participant) + (1+item|participant),
               family = binomial(link = "logit"),
               data = frontiers_long,
               control = lbfgs_ctrl)

print(anova(mod_0_LDTf, mod_1_LDTf, mod_2_LDTf, mod_3_LDTf,mod_4_LDTf, mod_5_LDTf ))
```
```{r}
print(summary(mod_2_LDTf))
```
