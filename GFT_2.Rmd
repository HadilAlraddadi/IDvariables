...
AHS significntly better than the RT1 and RT2.
POST HOC SHOWS RT1=RT2 and AHS significantly higher than both groups
...
```
model with Arabic global scale 
```{r}
mod_0_globalgap <- glmer(accuracy ~ 1 + (1|participant),
               family = binomial(link = "logit"), 
               data = frontiersGap_final,
               control = lbfgs_ctrl)

mod_1_globalgap <- glmer(accuracy ~ 1 + (1|participant) + (1|item),
               family = binomial(link = "logit"), 
               data = frontiersGap_final,
               control = lbfgs_ctrl)

mod_2_globalgap <- glmer(accuracy ~ Arabic_glob_scale + (1|participant) + (1|item),
               family = binomial(link = "logit"),
               data = frontiersGap_final,
               control = lbfgs_ctrl)

mod_3_globalgap <- glmer(accuracy ~ Arabic_glob_scale *condition + (1|participant) + (1|item) + English_glob_scale,
               family = binomial(link = "logit"),
               data = frontiersGap_final,
               control = lbfgs_ctrl)

mod_4_globalgap <- glmer(accuracy ~ Arabic_glob_scale *condition + (1|participant) + (1|item) + (1+condition | participant),
               family = binomial(link = "logit"),
               data = frontiersGap_final,
               control = lbfgs_ctrl)
...
print(anova(mod_1_globalgap, mod_2_globalgap, mod_3_globalgap, mod_4_globalgap ))
```
```{r}
summary(mod_3_globalgap)
```
model with English global scale 
```{r}
mod_0_eglobalgap <- glmer(accuracy ~ 1 + (1|participant),
               family = binomial(link = "logit"), 
               data = frontiersGap_final,
               control = lbfgs_ctrl)

mod_1_eglobalgap <- glmer(accuracy ~ 1 + (1|participant) + (1|item),
               family = binomial(link = "logit"), 
               data = frontiersGap_final,
               control = lbfgs_ctrl)

mod_2_eglobalgap <- glmer(accuracy ~ English_glob_scale + (1|participant) + (1|item),
               family = binomial(link = "logit"),
               data = frontiersGap_final,
               control = lbfgs_ctrl)

mod_3_eglobalgap <- glmer(accuracy ~ English_glob_scale *condition + (1|participant) + (1|item),
               family = binomial(link = "logit"),
               data = frontiersGap_final,
               control = lbfgs_ctrl)

mod_4_eglobalgap <- glmer(accuracy ~ English_glob_scale *condition + (1|participant) + (1|item) + (1+condition | participant),
               family = binomial(link = "logit"),
               data = frontiersGap_final,
               control = lbfgs_ctrl)
...
print(anova(mod_1_eglobalgap, mod_2_eglobalgap, mod_3_eglobalgap, mod_4_eglobalgap ))
```
```{r}
summary(mod_2_eglobalgap)
```
...
```{r}
mod0_rta <- lmer(log_rt_gapfrontiers ~ 1 + (1|participant), data = frontiersGap_final)

mod1_rta <- lmer(log_rt_gapfrontiers ~ 1 + (1|participant) + (1|item), data = frontiersGap_final)

mod2_rta <- lmer(log_rt_gapfrontiers ~ Arabic_glob_scale*condition + Arabic_glob_scale+ length + (1|participant), data = frontiersGap_final)

mod3_rta <- lmer(log_rt_gapfrontiers ~ Arabic_glob_scale*condition + Arabic_glob_scale + length + (1|participant) + (1|item), data = frontiersGap_final)

mod4_rta <- lmer(log_rt_gapfrontiers ~ Arabic_glob_scale*condition + Arabic_glob_scale + length + aor_scale +l2onsetscale + lorus_scale + lorsa_scale + (1|participant) + (1|item), data = frontiersGap_final)

mod5_rta <- lmer(log_rt_gapfrontiers ~ Arabic_glob_scale*condition + Arabic_glob_scale + length + aor_scale +l2onsetscale + lorus_scale + lorsa_scale + (1|participant) + (1|item) + (1+condition | participant) + (1+item | participant), data = frontiersGap_final)


print(anova(mod0_rta, mod1_rta, mod2_rta, mod3_rta, mod4_rta,mod5_rta ))
```
...
Models with English global
```{r}
mod0_rte <- lmer(log_rt_gapfrontiers ~ 1 + (1|participant), data = frontiersGap_final)

mod1_rte <- lmer(log_rt_gapfrontiers ~ 1 + (1|participant) + (1|item), data = frontiersGap_final)

mod2_rte <- lmer(log_rt_gapfrontiers ~ English_glob_scale*condition + English_glob_scale+ length + (1|participant), data = frontiersGap_final)

mod3_rte <- lmer(log_rt_gapfrontiers ~ English_glob_scale*condition + English_glob_scale + length + (1|participant) + (1|item), data = frontiersGap_final)

mod4_rte <- lmer(log_rt_gapfrontiers ~ English_glob_scale*condition + English_glob_scale + length + aor_scale +l2onsetscale + lorus_scale + lorsa_scale + (1|participant) + (1|item), data = frontiersGap_final)

mod5_rte <- lmer(log_rt_gapfrontiers ~ English_glob_scale*condition + English_glob_scale + length + aor_scale +l2onsetscale + lorus_scale + lorsa_scale + (1|participant) + (1|item) + (1+condition | participant) + (1+item | participant), data = frontiersGap_final)


print(anova(mod0_rte, mod1_rte, mod2_rte, mod3_rte, mod4_rte,mod5_rte ))
```
